      ...
      >
        ...
        <View style={{ paddingTop: insets.top + 64, paddingBottom: 24 }}>
          ...
          <SpringIn>
            ...
            >
              India's calmest way to track spending, budget with intent, and
              grow what you keep.
            </Text>
          </SpringIn>
        </View>
          ...
          {canBiometricLogin ? (
            <PressableScale onPress={() => void faceId()}>
              ...
              >
                ...
                >{`Unlock with ${bioLabel}`}</Text>
              </View>
            </PressableScale>
          ) : null}
          <Text
            style={[styles.terms, { color: t.text3, fontFamily: weight(500) }]}
          >
